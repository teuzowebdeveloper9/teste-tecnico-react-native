...
import { HandleCreateActivity } from "../utils/handleCreateActivity";
import { useState } from "react";
import closeModalActivity from '@/images/closeModalActivity.png'

export default function FormToCreateActivity(){
      ...
      <View className="flex-1 bg-black/50 justify-center items-center">
        <View className="w-[90%] bg-white absolute bottom-0 p-4 rounded-md">
          <View className='justify-between items-center flex-row'>
           <Text className="text-lg font-bold mb-4">Registre sua atividade</Text>
